...
namespace VhackXtApi.Console
{
    public class Connection
    {
        ...
        public async Task<TransferResult> trojanTransfer()
        {
            ...
            var json = await Utils.JSONRequest("user::::pass::::uhash::::target", config.username + "::::" + config.password + "::::" + Cons.uHash + "::::" + IP, "vh_trTransfer.php");
        ...
        public async void clearLogs()
        {
            ...
            await Utils.JSONRequest("user::::pass::::uhash::::target", config.username + "::::" + config.password + "::::" + Cons.uHash + "::::" + IP, "vh_clearAccessLog.php");
        }
