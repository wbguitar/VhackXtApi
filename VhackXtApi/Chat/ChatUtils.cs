...
namespace VhackXtApi.Chat
{
    public class ChatUtils
    {
        ...
        public static void sendChatMessage(String message)
        {
            try
            {
                ...
                Cons.config.logger.Log("Sending: {0}", message);
            ...
            catch (IOException e)
            {
                ...
                Cons.config.logger.Log(e.StackTrace);
            }
        }
        ...
        static async void procLine(string readLine, String str2, vHackAPI api)
        {
    ...
    namespace Reqs
    {
        public class Join : IMessage
        {
            ...
            public object SyncRef => throw new NotImplementedException();

            public int ResponseCount => throw new NotImplementedException();

            string msg;
            public Join(vHackAPI api)
            {
                //String str2 = "v[" + api.getUsername();
                //String str2 = "v[" + api.getUsername() + "]";
        ...
        public class Message : IMessage
        {
            ...
            public static String vhackxy { get; private set; } = "#vHackXT";
            string str = "";
            public Message(string readLine, vHackAPI api)
            {
                SyncRef = new object();
    ...
    public static class ChatTest
    {
        ...
        public static void Test(vHackAPI api)
        {
            if (ci != null)
            {
                ci.DisposeClientTcp();
            ...
            ci.OnConnect += () => ci.SendMessage(new VhackXtApi.Chat.Reqs.Join(api));
            ...
            ci.MessageReceived += (msg, err) =>
            {
                ...
                if (msg.Display().Contains("PRIVMSG " + VhackXtApi.Chat.Reqs.Message.vhackxy + " :"))
                    System.Console.WriteLine(msg.Display());
                else
                {
                    try
                    {
                        var req = new VhackXtApi.Chat.Reqs.Message(msg.Display(), api);
                        req.Validate();
                        ci.SendMessage(req);
                    }
                    catch (VhackXtApi.Chat.Reqs.Message.NotValidException)
                    {
                        System.Console.WriteLine(msg.Display());
                    }
